   ...
   */
    ...
    public void setPixel(int x, int y, short red, short green, short blue) {
        ...
        // the target is either the first of next run, or the only one
            ...
            if (cur.getRunLengths() == 1) {
                // now same as both
                if (pre.getRed() == red && pre.getGreen() == green && pre.getBlue() == blue && nex.getRed() == red && nex.getGreen() == green && nex.getBlue() == blue) {
                    pre.setRunLengths(pre.getRunLengths() + nex.getRunLengths() + 1);
                    pre.next = nex.next;
                    nex.next.prev = pre;
                    length = length - 2;
                }
                // now same as previous
                else if (pre.getRed() == red && pre.getGreen() == green && pre.getBlue() == blue) {
                    pre.setRunLengths(pre.getRunLengths()+1);
		    pre.next = nex;
		    nex.prev = pre;
                    length--;
                ...
                // now same as next
                else if (nex.getRed() == red && nex.getGreen() == green && nex.getBlue() == blue) {
                    nex.setRunLengths(nex.getRunLengths()+1);
		    pre.next = nex;
		    nex.prev = pre;
                    length--;
                }
