...
public class RunIterator implements Iterator {
   ...
   */
    private RunLengthEncoding parentList;
    private PixelNode currentNode;
  ...
  RunIterator(RunLengthEncoding rL) {
      parentList = rL;
  ...
  public boolean hasNext() {
      if (currentNode.next == parentList.getHead()) return false;
      else return true;
  }
  ...
  public int[] next() {
    ...
    // Replace the following line with your solution.
      ...
      result[0] = currentNode.getRunLengths();
      result[1] = currentNode.getRed();
      result[2] = currentNode.getGreen();
      result[3] = currentNode.getBlue();
      return result;
  }
